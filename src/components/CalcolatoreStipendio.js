...
function CalcolatoreStipendio() {
  ...
  const totaleOre = Object.values(oreLavorate).reduce((acc, ore) => acc + ore, 0);
    ...
    <ThemeProvider theme={theme}>
      <Box sx={{
        ...
        <Paper elevation={3} sx={{ p: 4, backgroundColor: 'rgba(255, 255, 255, 0.9)' }}>
          ...
          <Typography sx={{ color: theme.palette.primary.main, fontSize: '1.1rem' }}>
            Ore totali: {formatTimeFromHours(totaleOre)}
          </Typography>
          <Typography sx={{ color: theme.palette.primary.main, fontSize: '1.1rem', fontWeight: 'bold' }}>
      ...
      >
        ...
        <DialogContent>
          <Typography>
            Sei sicuro di voler eliminare tutti i giorni lavorativi? Questa azione non può essere annullata.
          </Typography>
        </DialogContent>
        <DialogActions>
